  ...
  <div>
    <el-card class="box-card"
      ...
      <div>
        ...
        <el-tag style="margin-top:15px;display:block;"
                type="info">
          {{ $t('i18nView.note') }}
        </el-tag>
      </div>
    ...
    <el-row :gutter="20"
      ...
      <el-col :span="12"
        ...
        <el-table :data="tableData"
                  ...
                  border
                  style="width: 100%">
          <el-table-column :label="$t('i18nView.tableName')"
                           prop="name"
                           width="100"
                           align="center" />
          <el-table-column :label="$t('i18nView.tableDate')"
                           prop="date"
                           width="120"
                           align="center" />
          <el-table-column :label="$t('i18nView.tableAddress')"
                           prop="address" />
        </el-table>
      </el-col>
    </el-row>
